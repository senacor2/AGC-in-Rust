...
pub const STAR_CATALOG: [StarEntry; 37] = [
    StarEntry { number:  1, name: "Alpheratz",    direction: [ 0.8748658918,  0.0260879174,  0.4836621670] },
    StarEntry { number:  2, name: "Diphda",       direction: [ 0.9342640400,  0.1735073142, -0.3115219339] },
    StarEntry { number:  3, name: "Navi",         direction: [ 0.4775639450,  0.1166004340,  0.8708254803] },
    StarEntry { number:  4, name: "Achernar",     direction: [ 0.4917678276,  0.2204887125, -0.8423473935] },
    StarEntry { number:  5, name: "Polaris",      direction: [ 0.0130968840,  0.0078062795,  0.9998837600] },
    StarEntry { number:  6, name: "Acamar",       direction: [ 0.5450107404,  0.5314955466, -0.6484410356] },
    StarEntry { number:  7, name: "Hamal",        direction: [ 0.7032235469,  0.7075846047,  0.0692868685] },
    StarEntry { number:  8, name: "Menkar",       direction: [ 0.4105636020,  0.4988110001,  0.7632988371] },
    StarEntry { number:  9, name: "Mirfak",       direction: [ 0.3507315038,  0.8926333307,  0.2831839492] },
    StarEntry { number: 10, name: "Aldebaran",    direction: [ 0.2011399589,  0.9690337941, -0.1432348512] },
    StarEntry { number: 11, name: "Rigel",        direction: [ 0.1371725575,  0.6813721061,  0.7189685267] },
    StarEntry { number: 12, name: "Capella",      direction: [-0.0614937230,  0.6031563286, -0.7952489957] },
    StarEntry { number: 13, name: "Canopus",      direction: [-0.1820751783,  0.9404899869, -0.2869271926] },
    StarEntry { number: 14, name: "Sirius",       direction: [-0.4118589524,  0.9065485360,  0.0924226975] },
    StarEntry { number: 15, name: "Regor",        direction: [-0.3612508532,  0.5747270840, -0.7342932655] },
    StarEntry { number: 16, name: "Pollux",       direction: [-0.4657947941,  0.4774785033,  0.7450164351] },
    StarEntry { number: 17, name: "Regor",        direction: [-0.7742591356,  0.6152504197, -0.1482892839] },
    StarEntry { number: 18, name: "Dnoces",       direction: [-0.8608205219,  0.4636213989,  0.2098647835] },
    StarEntry { number: 19, name: "Alphard",      direction: [-0.9656605484,  0.0525933156,  0.2544280809] },
    StarEntry { number: 20, name: "Regulus",      direction: [-0.9525211695, -0.0593434796, -0.2986331746] },
    StarEntry { number: 21, name: "Acrux",        direction: [-0.4523440203, -0.0493710140, -0.8904759346] },
    StarEntry { number: 22, name: "Menkent",      direction: [-0.9170097662, -0.3502146628, -0.1908999176] },
    StarEntry { number: 23, name: "Alphecca",     direction: [-0.5812035376, -0.2909171294,  0.7599800468] },
    StarEntry { number: 24, name: "Atria",        direction: [-0.6898393233, -0.4182330640, -0.5909338474] },
    StarEntry { number: 25, name: "Antares",      direction: [-0.7861763936, -0.5217996305,  0.3311371675] },
    StarEntry { number: 26, name: "Rasalhague",   direction: [-0.5326876930, -0.7160644554,  0.4511047742] },
    StarEntry { number: 27, name: "Nunki",        direction: [-0.3516499609, -0.8240752703, -0.4441196390] },
    StarEntry { number: 28, name: "Rigil Kent",   direction: [-0.1146237858, -0.3399692557, -0.9334250333] },
    StarEntry { number: 29, name: "Kaus Austr",   direction: [-0.1124304773, -0.9694934200,  0.2178116072] },
    StarEntry { number: 30, name: "Vega",         direction: [ 0.1217293692, -0.7702732847,  0.6259880410] },
    StarEntry { number: 31, name: "Nunki",        direction: [ 0.2069525789, -0.8719885748, -0.4436288486] },
    StarEntry { number: 32, name: "Dabih",        direction: [ 0.4537196908, -0.8779508801,  0.1527766153] },
    StarEntry { number: 33, name: "Peacock",      direction: [ 0.5520184464, -0.7933187400, -0.2567508745] },
    StarEntry { number: 34, name: "Alnair",       direction: [ 0.3201817378, -0.4436021946, -0.8370786986] },
    StarEntry { number: 35, name: "Fomalhaut",    direction: [ 0.4541086270, -0.5392368197,  0.7092312789] },
    StarEntry { number: 36, name: "Markab",       direction: [ 0.8139832631, -0.5557243189,  0.1691204557] },
    StarEntry { number: 37, name: "Deneb",        direction: [ 0.8342971408, -0.2392481515, -0.4966976975] },
];
...
mod tests {
    ...
    fn tc_star_3_star_direction_boundary_cases() {
        ...
        assert_eq!(star_direction(0), None, "star_direction(0) must be None (planet mode)");
        ...
        assert_eq!(star_direction(38), None, "star_direction(38) must be None (stored-track range)");
        assert_eq!(star_direction(50), None, "star_direction(50) must be None");
        assert_eq!(star_direction(255), None, "star_direction(255) must be None (way out of range)");
    }
