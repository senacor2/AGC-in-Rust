...
//! STM32F767ZI microcontroller (ADR-021 — supersedes the F722ZE choice in
//! ADR-011, which mistakenly assumed F722 had a hardware DPFPU).
//! External peripherals (DSKY, sextant, engines) are reached through a
//! USART6 bridge link using the `agc-protocol` framing.
