...
fn main() -> ! {
    ...
    use agc_board_nucleo_f767::local::imu::bmi088::Bmi088Driver;
    ...
    use agc_board_nucleo_f767::local::timers::LocalTimers;
    ...
    {
        use agc_board_nucleo_f767::Board;
    ...
    // ── Hello handshake ───────────────────────────────────────────────────────
    agc_board_nucleo_f767::with_bridge_and_link(|link, bridge| {
